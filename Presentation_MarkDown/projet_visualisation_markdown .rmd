...
Pour evoluer à certains postes, le joueur doit posseder certains critères. Certains postes necissitent d'être particulierement grand et costaud ou au contraire moins grand, rapide et agile comme en temoignent les représentations suivantes :
```{r echo=FALSE, warning=FALSE}
...
- La plupart des meilleurs gardiens dans le monde du football son grand de taille et un poids assez elevé. Ce qui nous laisse penser qu'un gardien aillant ces critères a de forte chance de faire partir des meilleurs.
...
- Concernant les milieux de terrain, les critères ci dessus ne sont pas indispensables pour faire partir des meilleurs. Un joueur peux avoir une petite taille et etre performant à son poste et inversement.
- Pour le secteur offensif, la majorité des ailiers font moins 180cm et moins de 80kg contrairement aux attaquants dont la majorité ont une taille supérieur à 180cm et un poids supérieur 75kg. Par conséquent un ailier ou un attaquant qui possède ces caractéristiques pourrait faire partir des meilleurs.  
